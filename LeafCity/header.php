...
<div>
    <div title="fMoeErrorReporter" style="margin:0 auto;width:100%;color:blue;text-align:center;font-size:15px;z-index:9999999;font-weight:blod;">
        ...
        <!--[if lt IE 9]><div style="padding:5px;background:#ffff88;">您的浏览器版本过旧，请升级浏览器获得更好的体验，推荐使用 Chrome 浏览器！</div><![endif]--><!--[if lt IE 8]><div style="padding:5px;background-color:red;color:#fff;">您还在用这么古老的浏览器？！别逗比了，赶紧升级浏览器吧！</div><![endif]-->
    </div>
</div>
<div class="header">
    <div class="mob">
        ...
        <a class="menuicon" href="javascript:void(0);" title="Menu">
            <i class="icon-menu"></i>
        </a>
    </div>
</div>